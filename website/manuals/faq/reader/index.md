...
Besides network-related problems, **Futon** may occasionally fail to recognize certain images. To address this, simply exit and re-enter the reader or click **Try again** button, often resolving the issue.
...
For detailed instructions, please consult the guides section on the website.
